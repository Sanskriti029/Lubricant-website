          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <div className="bg-gray-50 rounded-2xl shadow-sm p-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="mb-0">Phone: 9827003016</p>
              </div>
            </div>
            <div className="bg-gray-50 rounded-2xl shadow-sm p-6">
            ...
            <div className="bg-gray-50 rounded-2xl shadow-sm p-6">
              <h3 className="text-xl font-bold mb-4">Our Instagram Information</h3>
              <div className="flex items-center gap-3">
                <img src={instagram} alt="Instagram" className="h-6 w-6" />
                <p className="mb-0">Instagram: @vikasautomobiles</p>
              </div>
            </div>
            <div className="bg-gray-50 rounded-2xl shadow-sm p-6">
              <h3 className="text-xl font-bold mb-4">Our Twitter Information</h3>
              <div className="flex items-center gap-3">
                <img src={twitter} alt="Twitter" className="h-6 w-6" />
                <p className="mb-0">Twitter: @vikasautomobiles</p>
              </div>
            </div>
            
            <div className="bg-gray-50 rounded-2xl shadow-sm p-6">
              <h3 className="text-xl font-bold mb-4">Our Whatsapp Information</h3>
              <div className="flex items-center gap-3">
                <img src={whatsapp} alt="whatsapp" className="h-6 w-6" />
                <p className="mb-0">whatsapp: 9827003016</p>
              </div>
            </div>
